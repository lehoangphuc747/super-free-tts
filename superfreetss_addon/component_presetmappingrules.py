...
from . import component_mappingrule
...
class ComponentPresetMappingRules(component_common.ConfigComponentBase):
    ...
    def draw(self, layout):
        ...
        self.note_info_groupbox = aqt.qt.QGroupBox(i18n.get_text("preset_rules_group_note_info", lang))
        ...
        instructions_groubox = aqt.qt.QGroupBox(i18n.get_text("preset_rules_group_need_help", lang))
        ...
        settings_groupbox = aqt.qt.QGroupBox(i18n.get_text("preset_rules_group_settings", lang))
        ...
        self.preview_all_button = aqt.qt.QPushButton(i18n.get_text("preset_rules_button_preview_all", lang))
        self.preview_all_button.setToolTip('Preview all Presets (Hear all the audio)')
        hlayout.addWidget(self.preview_all_button)

        self.run_all_button = aqt.qt.QPushButton(i18n.get_text("preset_rules_button_run_all", lang))
        self.run_all_button.setToolTip('Run all Presets (Add all audio to your note)')
        hlayout.addWidget(self.run_all_button)

        self.add_rule_button = aqt.qt.QPushButton(i18n.get_text("preset_rules_button_add_rule", lang))
        ...
        self.mapping_rules_groupbox = aqt.qt.QGroupBox(i18n.get_text("preset_rules_group_preset_rules", lang))
