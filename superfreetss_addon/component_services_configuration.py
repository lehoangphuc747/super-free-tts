...
class ServicesConfigurationDialog(aqt.qt.QDialog):
    ...
    def setupUi(self):
        ...
        trial_button_style = f"""
            QLabel {{
                border: 1px solid {constants.COLOR_PRIMARY};
                border-radius: 12px;
                padding: 24px;
            ...
            QLabel:hover {{
                ...
                border-color: {constants.COLOR_ACCENT};
            }}
        """
        ...
        <div style='color: white;'>
            <h3 style='font-size: 18px; margin-bottom: 8px;'>{trial_title}</h3>
            <p style='font-size: 13px; line-height: 1.4;'>{trial_description}</p>
            <p style='font-size: 12px; color: {constants.COLOR_ACCENT}; margin-top: 10px;'><b>★ {trial_recommended}</b></p>
        </div>
        """
        ...
        self.trial_button.setCursor(aqt.qt.Qt.CursorShape.PointingHandCursor)
        ...
        manual_html = f"""
        <div>
            <h3 style='font-size: 16px; margin-bottom: 6px;'>{manual_title}</h3>
            <p style='font-size: 12px; line-height: 1.4; color: {constants.COLOR_SECONDARY};'>{manual_description}</p>
            <p style='font-size: 11px; font-style: italic; margin-top: 8px;'>{manual_recommended}</p>
        </div>
        """
        ...
        self.manual_button.setCursor(aqt.qt.Qt.CursorShape.PointingHandCursor)
