...
class TrialSignup(component_common.ConfigComponentBase):
    ...
    def create_signup_screen(self):
        ...
        # Add title label
        title_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_ALTERNATE_TITLE)
        ...
        benefits_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_ALTERNATE_BENEFITS)
        ...
        # Button
        self.signup_button = aqt.qt.QPushButton(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_ALTERNATE_BUTTON)
        gui_utils.configure_primary_button(self.signup_button)
        ...
        privacy_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_ALTERNATE_PRIVACY)
    ...
    def create_verification_screen(self):
        ...
        # Description label
        description_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_VERIFY_EMAIL)
        ...
        self.verification_description_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_VERIFICATION_DESCRIPTION)
        self.verification_description_label.setWordWrap(True)
        form_layout.addWidget(self.verification_description_label)
        
        # Status label
        self.verification_status_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_VERIFICATION_INITIAL_STATUS)
        ...
        gui_utils.configure_primary_button(self.check_status_button, min_height=40, min_width=150)
    ...
    def create_verified_screen(self):
        ...
        # Title label
        title_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_VERIFIED_TITLE)
        title_label.setWordWrap(True)
        title_label.setAlignment(aqt.qt.Qt.AlignmentFlag.AlignLeft)
        title_label.setStyleSheet('border: none; background-color: transparent;')
        font = title_label.font()
        ...
        # Description label
        description_label = aqt.qt.QLabel(constants.GUI_TEXT_SUPERFREETSS_PRO_TRIAL_VERIFIED_DESCRIPTION)
        description_label.setWordWrap(True)
        ...
        gui_utils.configure_primary_button(self.how_to_add_audio_button, min_height=40, min_width=200)
    ...
    def trial_signup_success(self, trial_signup_result: config_models.TrialRequestReponse):
        ...
        self.hypertts.save_superfreetss_pro_api_key(trial_signup_result.api_key)
...
class TrialSignupDialog(aqt.qt.QDialog):
    ...
    def setupUi(self):
        self.setWindowTitle(constants.TITLE_PREFIX + 'Pro Trial Signup')
