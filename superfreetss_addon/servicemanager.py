    ...
    def instantiate_services(self):
        for subclass in service.ServiceBase.__subclasses__():
            ...
            if subclass_instance.test_service() and self.allow_test_services == False:
                ...
                continue
            # Super Free TTS: Only instantiate free services
            if subclass_instance.service_fee == constants.ServiceFee.paid:
                logger.info(f'skipping paid service {subclass_instance.name}')
                continue
